...
do
    ...
    if f then
        ...
        logToConsole("`4Failed to open world list file")
    end
end
...
runThread(function()
    for _, worldName in ipairs(worlds) do
        if not visited[worldName] then
            visited[worldName] = true
            webhookMessage = ""
            punched = {}
            ...
            logToConsole("`9Joining world: `5" .. worldName)
            sleep(3000)
